...
class RateLimitFilterTest {
    ...
    void appliesAuthLimitToVerificationAndPasswordResetEndpoints() throws Exception {
        for (String path : List.of(
            ...
            RateLimitFilter.RateLimitFilterSupport filter = newFilter();
    ...
    void ignoresUntrustedForwardedAddressesWhenRateLimiting() throws Exception {
        ...
        assertThat(filterStatusWithForwarded(filter, "203.0.113.1")).isEqualTo(200);
        assertThat(filterStatusWithForwarded(filter, "198.51.100.2")).isEqualTo(429);
    }

    private RateLimitFilter.RateLimitFilterSupport newFilter() {
        return new RateLimitFilter.RateLimitFilterSupport(
                null,
    ...
    private int filterStatus(
            RateLimitFilter.RateLimitFilterSupport filter,
            String path
    ) throws Exception {
    ...
    private int filterStatusWithForwarded(
            RateLimitFilter.RateLimitFilterSupport filter,
            String forwardedFor
    ) throws Exception {
